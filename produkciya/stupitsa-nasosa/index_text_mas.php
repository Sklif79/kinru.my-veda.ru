<img src="/bitrix/images/seo/styp.png" alt="ступица насоса гидротрансформатора"> <br>
 <br>
<br>
<div style="width: 1050px;">
 ...
 <span style="color: #363434; font-size: 15pt;">Связаться с отделом продаж для бесплатной консультации</span>
			<ul>
				...
				<li style="list-style-type: none; padding-top: 10px; font-weight: bold; font-size: 16pt;"><span style="font-weight: normal;">e-mail:</span> admin@kinergo.ru</li>
			</ul>
		</div>
		<div>
 <span style="font-size: 20pt; color: #7b7b7b; position: relative; left: 610px; bottom: 50px;">или</span> <a href="#" namem="ступица насоса гидротрансформатора," class="cenazakaz_open" data-popup-ordinal="1" id="open_69339447" style="color: white; text-decoration: none;">
...
<h2>Полезное видео про ступицу насоса гидротрансформатора</h2>
<iframe width="854" height="480" src="https://www.youtube.com/embed/CVQeAD7cfSU" frameborder="0" allowfullscreen></iframe>